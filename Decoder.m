...
case 7
            ...
            prob_dec(t)=(indiv_prob_dec(i)*trans_prob_dec(i,j)*trans_prob_dec(j,k)*trans_prob_dec(k,l)*trans_prob_dec(l,m)*trans_prob_dec(m,n)*trans_prob_dec(n,x));
            symbols_dec(t)=str2double(strcat(original_symbols_dec(i),original_symbols_dec(j),original_symbols_dec(k),original_symbols_dec(l),original_symbols_dec(m),original_symbols_dec(n),original_symbols_dec(x)));         
            t=t+1;
            end
            end
            end
...
case 8
            ...
            prob_dec(t)=(indiv_prob_dec(i)*trans_prob_dec(i,j)*trans_prob_dec(j,k)*trans_prob_dec(k,l)*trans_prob_dec(l,m)*trans_prob_dec(m,n)*trans_prob_dec(n,x)*trans_prob_dec(x,y));
            symbols_dec(t)=str2double(strcat(original_symbols_dec(i),original_symbols_dec(j),original_symbols_dec(k),original_symbols_dec(l),original_symbols_dec(m),original_symbols_dec(n),original_symbols_dec(x),original_symbols_dec(y)));              
            t=t+1;
            end
            end
            end
    ...
    case 9
            ...
            prob_dec(t)=(indiv_prob_dec(i)*trans_prob_dec(i,j)*trans_prob_dec(j,k)*trans_prob_dec(k,l)*trans_prob_dec(l,m)*trans_prob_dec(m,n)*trans_prob_dec(n,x)*trans_prob_dec(x,y)*trans_prob_dec(y,z));
            symbols_dec(t)=str2double(strcat(original_symbols_dec(i),original_symbols_dec(j),original_symbols_dec(k),original_symbols_dec(l),original_symbols_dec(m),original_symbols_dec(n),original_symbols_dec(x),original_symbols_dec(y),original_symbols_dec(z)));              
            t=t+1;
            end
            end
            end
...
for i=1:length(seq_dec) 
   fprintf(fileID,'%d',seq_dec(i));
end
fclose(fileID);
